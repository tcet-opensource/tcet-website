...
const TestimonialsExperts = () => {
    const slideObjExperts = [
        {
    ...
    const mappedSlides = slideObjExperts.map((data) => {
      return (
    ...
    return (
      ...
      <div class="flex flex-col px-5 gap-4">
        <div class="flex flex-start px-2 py-3 font-inter font-semibold text-md sm-text-md lg:text-xl text-green-600 border rounded-md bg-green-100">EXPERTS</div>
      </div>
        <Swiper
  ...
  export default TestimonialsExperts;