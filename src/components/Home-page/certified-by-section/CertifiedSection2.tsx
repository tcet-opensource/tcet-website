...
interface CertiProps {
  ...
  const certifiedSection2: React.FC<CertiProps> = ({ img,text }) => {
    return (
      <div className=' w-fit h-fit  p-3 gap-2 items-center flex flex-col md:flex-row border border-solid border-gray-300 shadow-sm md:shadow-md rounded-lg sm:self-stretch'>
        <div>
